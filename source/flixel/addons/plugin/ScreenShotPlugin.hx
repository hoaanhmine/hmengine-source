...
class ScreenShotPlugin extends flixel.FlxBasic {
    ...
    override public function new():Void {
        ...
        screenshotContainer = new Sprite();
        FlxG.stage.addChild(screenshotContainer);
        ...
        screenshotContainer.addChild(screenshotSprite);
        ...
        screenshotContainer.addChild(flashSprite);
    ...
    override public function destroy():Void {
        ...
        FlxG.stage.removeChild(screenshotContainer);
        ...
        @:privateAccess
        for (parent in [screenshotContainer, flashSprite, screenshotSprite])
